...
var _excluded31 = ["className", "columns", "container", "component", "direction", "wrap", "spacing", "rowSpacing", "columnSpacing"];
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React72.useState(false);
...
var TouchRipple = React73.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const [ripples, setRipples] = React73.useState([]);
  const nextKey = React73.useRef(0);
  const rippleCallback = React73.useRef(null);
  React73.useEffect(() => {
  ...
  const ignoringMouseDown = React73.useRef(false);
  const startTimer = React73.useRef(null);
  const startTimerCommit = React73.useRef(null);
  const container = React73.useRef(null);
  React73.useEffect(() => {
    return () => {
      clearTimeout(startTimer.current);
    };
  }, []);
  const startCommit = React73.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
    ...
    setRipples((oldRipples) => [...oldRipples, (0, import_jsx_runtime46.jsx)(TouchRippleRipple, {
      classes: {
  ...
  const start2 = React73.useCallback((event = {}, options = {}, cb) => {
    const {
  ...
  const pulsate = React73.useCallback(() => {
    start2({}, {
      pulsate: true
    });
  }, [start2]);
  const stop = React73.useCallback((event, cb) => {
    clearTimeout(startTimer.current);
  ...
  return (0, import_jsx_runtime46.jsx)(TouchRippleRoot, _extends({
    className: clsx_m_default(classes.root, touchRippleClasses_default.root, className),
    ref: container
  }, other, {
    children: (0, import_jsx_runtime46.jsx)(TransitionGroup_default, {
      component: null,
      exit: true,
      children: ripples
    })
...
var ButtonBase = React74.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  const rippleRef = React74.useRef(null);
  ...
  const keydownRef = React74.useRef(false);
  ...
  return (0, import_jsx_runtime48.jsxs)(ButtonBaseRoot, _extends({
    as: ComponentProp,
    className: clsx_m_default(classes.root, className),
    ownerState,
    onBlur: handleBlur2,
    ...
    children: [children2, enableTouchRipple ? (0, import_jsx_runtime47.jsx)(TouchRipple_default, _extends({
      ref: handleRippleRef,
      center: centerRipple
...
var ButtonGroupContext = React75.createContext({});
if (true) {
...
var Button = React76.forwardRef(function Button2(inProps, ref) {
