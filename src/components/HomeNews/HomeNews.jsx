...
function HomeNews() {
  ...
  return (
    <div className='home-news'>
        ...
        {newsLimit ? <h3>Uh oh! The News API is at its limit. Try navigating to a different sport or come back in a minute.</h3> : (loading ? (<div class="lds-ellipsis"><div></div><div></div><div></div><div></div></div>) : (
