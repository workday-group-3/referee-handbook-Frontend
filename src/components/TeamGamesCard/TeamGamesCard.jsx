...
function TeamGamesCard(props) {
  return (
    <div className='team-games-card'>
      <p className='WDL'>{props.team.WDL}</p>
      <img className='opponent-logo' src={props.team.location == "HOME" ? props.team.away.logo : props.team.home.logo} alt="opponent-logo"></img>
      ...
      <p className='opponent-name'>vs {props.team.location == "HOME" ? props.team.away.name : props.team.home.name}</p>
