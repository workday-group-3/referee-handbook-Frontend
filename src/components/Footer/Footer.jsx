        ...
        <div className="footer">
            <div className="top-half-container">
                ...
                <div className="footer-header">
                    ...
                    <div className='footer-body-top'>
                       <p className ="footer-body"><a target="_blank" href="https://api-sports.io/"><img id = "api-sports-logo" src="https://pbs.twimg.com/profile_images/1248589572730044423/bdT7f7ig_400x400.jpg"></img></a></p>      <p className ="footer-body"><a target="_blank" href="https://timeline.knightlab.com/"><img id ="knightlabs-logo" src="https://cdn.knightlab.com/libs/orangeline/latest/assets/knightlab-dark.png"></img></a></p>
                    </div>
